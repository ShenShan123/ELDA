# Frozen ELDA split identity

This source repository intentionally contains only compact, path-independent
metadata for the frozen ELDA corpus. The complete split lists, `meta.pt`, and
...
must contain `meta.pt`, `mapping.txt`, and the three source-clean split
...
The selected checkpoint used the pre-audit split. New training uses
