...
`data_sample/cells.v` is a new minimal behavioral smoke-test model written for
this supplement. It is not copied from a PDK or Liberty library. No Nangate45
Liberty file, proprietary RTL, model cache, or third-party benchmark source is
included.
